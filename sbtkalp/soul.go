...
func (s *SmartContract) Initialize(sdk kalpsdk.TransactionContextInterface, description string) error {
    ...
    // NFTMetadata.Description = metadata
...
func (s *SmartContract) MintSBT(sdk kalpsdk.TransactionContextInterface, address string, name string, organization string, dateOfIssue string, ipfsHash string) error {
...
// GetTokenMetadata - retrieves the TokenID associated with an owner
